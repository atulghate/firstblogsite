...
$obj = new Comm();
$obj->addcomment($cid,$cname,$msg, $email );
...
<head>
  ...
  <link rel="stylesheet" href="\..\css&scss\index.css">
   <link rel="stylesheet" href="\..\css&scss\com.css"> 
...
<body>
  <nav>
    ...
    <div class="iconn">
      <img src="imagess\sun.png" id="icon">
    </div>
